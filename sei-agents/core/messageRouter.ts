...
export class MessageRouter extends EventEmitter {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      await this.messageQueue.createQueue('high-priority');
      await this.messageQueue.createQueue('normal-priority');
      await this.messageQueue.createQueue('low-priority');
      await this.messageQueue.createQueue('dead-letter');
...
export async function startMessageRouter(): Promise<void> {
